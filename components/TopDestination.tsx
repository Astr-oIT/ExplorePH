...
const TopDestination = () => {
    ...
    return (
        <View style={styles.gridRow}>
            ...
            >
                <TouchableOpacity style={styles.gridBox} onPress={() => openModal({ imageUri: 'https://philippinetourismusa.com/wp-content/uploads/2021/09/Bantayan-Island-Cebu_1.jpg' })}>
                    <Image
                ...
                <TouchableOpacity style={styles.gridBox} onPress={() => openModal({ imageUri: 'https://images.summitmedia-digital.com/cosmo/images/2014-images/july_2014/07-05-2014/batulao.jpg' })}>
                    <Image
                ...
                <TouchableOpacity style={styles.gridBox} onPress={() => openModal({ imageUri: 'https://images.summitmedia-digital.com/cosmo/images/2014-images/july_2014/07-05-2014/batulao.jpg' })}>
                    <Image
                        source={{ uri: 'https://leisureopportunities.co.uk/images/HIGH436928_838902.jpg' }}
                        style={styles.image}
                    />
                    <Text style={styles.TextTop}>HotSpring</Text>
                </TouchableOpacity>
            </Animated.ScrollView>
